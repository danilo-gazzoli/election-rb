...
ActiveRecord::Schema[7.1].define(version: 20_250_311_130_355) do
  ...
  create_table 'elections_offices', id: false, force: :cascade do |t|
    t.bigint 'election_id', null: false
    t.bigint 'office_id', null: false
    t.index %w[election_id office_id], name: 'index_elections_offices_on_election_id_and_office_id'
    t.index %w[office_id election_id], name: 'index_elections_offices_on_office_id_and_election_id'
  end
